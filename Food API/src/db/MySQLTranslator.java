 ...
 * NEEDS UPDATING going to try to add MySQL Server tomorrow.
 * Last Updated 03/24/21
 * @author iquigley, Modified by Andy Cruse
 */
...
public class MySQLTranslator implements DBTranslatorInterface {
    ...
    //NEEDS UPDATE TO OUR PROGRAM'S SERVER
    ...
    private static final String db_name = "chess_game";
